...
class Tag extends Model
{
    ...
    /**
     * Scope a query to include post count for each tag.
     */
    ...
    /**
     * Scope a query to get popular tags ordered by post count.
     */
    ...
    private function slugExists($slug)
    {
        ...
        // If updating an existing tag, exclude current tag from check
        if ($this->exists) {
